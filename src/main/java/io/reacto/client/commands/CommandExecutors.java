...
import io.reacto.client.commands.hystrix.HystrixCommandExecutor;
import io.reacto.client.commands.hystrix.HystrixObservableCommandWrapper;
import io.reacto.client.commands.hystrix.HystrixTimeOutCommandExecutor;
import io.reacto.types.Event;
import io.reacto.client.events.VertxWebSocketEventHandler;
import io.reacto.types.Command;
import rx.Observable;

import java.util.function.Function;

import static io.reacto.mappers.Mappers.mapToEventHandlers;
